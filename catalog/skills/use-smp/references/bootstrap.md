...
>
> 1. Review the blueprint for this domain at `https://www.semantius.com/blueprints/smp`. This page describes the blueprint and how to download it with the `semantius-admin` skill.
