...
name: use-ats
description: >-
  Applicant Tracking and Recruiting (ATS). Hire faster with a connected pipeline from sourcing through offer acceptance. Use for: recruiting, hiring, talent acquisition, applicant tracking, candidate management, hiring pipeline, job requisition, interview scheduling, offer management, background check, EEOC compliance, ATS.
---
