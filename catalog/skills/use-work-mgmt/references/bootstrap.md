...
> The `Work Management` domain is not deployed in your platform. No live module hosts its entities, and no module carries its catalog codes. Deploy the domain blueprint first:
>
> 1. Review the blueprint for this domain at `https://www.semantius.com/blueprints/work-mgmt`. This page describes the blueprint and how to download it with the `semantius-admin` skill.
