...
domain_modules:
  - lms-course-delivery
domain_code: LMS
related_modules: [ats-candidate-crm, ats-recruitment-pipeline, ben-enrollment, comp-planning, emp-exp-continuous-listen, erp-fin-gl-close, hcm-core-worker, hcm-lifecycle-workflows, hcm-org-positions, hrsd-case-mgmt, iga-access-request, lms-automation, lms-compliance-training, lms-credentials, lms-ilt-delivery, lms-paths, pa-predictive-models, payroll-run, psa-project-delivery, psa-resource-mgmt, skills-mgmt-profile, talent-performance-mgmt, talent-succession-career, training-records-starter]
...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `assessment_attempts` | Assessment Attempt | Assessment Attempts | master | operational_workflow | - | - | required | personal_content, submit_lock | `:manage` | - |
| 2 | `assessment_questions` | Assessment Question | Assessment Questions | master | catalog | - | - | required | - | `:admin` | - |
| 3 | `course_assessments` | Course Assessment | Course Assessments | master | operational_workflow | - | - | required | submit_lock | `:manage` | - |
| 4 | `course_catalogs` | Course Catalog | Course Catalogs | master | catalog | - | - | required | - | `:admin` | - |
| 5 | `course_categories` | Course Category | Course Categories | master | catalog | - | - | required | - | `:admin` | - |
| 6 | `course_completions` | Course Completion | Course Completions | master | operational_record | - | - | required | personal_content, submit_lock | `:manage` | - |
| 7 | `course_discussions` | Course Discussion | Course Discussions | master | operational_record | - | - | required | personal_content | `:manage` | - |
| 8 | `course_enrollments` | Course Enrollment | Course Enrollments | master | operational_workflow | - | - | required | personal_content | `:manage` | - |
| 9 | `course_modules` | Course Module | Course Modules | master | catalog | - | - | required | - | `:admin` | - |
| 10 | `course_ratings` | Course Rating | Course Ratings | master | operational_record | - | - | required | personal_content | `:manage` | - |
| 11 | `course_reviews` | Course Review | Course Reviews | master | operational_record | - | - | required | personal_content, submit_lock | `:manage` | - |
| 12 | `course_tags` | Course Tag | Course Tags | master | catalog | - | - | required | - | `:admin` | - |
| 13 | `course_versions` | Course Version | Course Versions | master | operational_workflow | - | - | required | submit_lock | `:manage` | - |
| 14 | `courses` | Course | Courses | master | operational_workflow | - | - | required | - | `:manage` | - |
| 15 | `learning_content_assets` | Learning Content Asset | Learning Content Assets | master | catalog | - | - | required | - | `:admin` | - |
| 16 | `learning_records` | Learning Record | Learning Records | master | operational_record | - | - | required | personal_content | `:manage` | - |
| 17 | `lessons` | Lesson | Lessons | master | catalog | - | - | required | - | `:admin` | - |
| 18 | `quiz_responses` | Quiz Response | Quiz Responses | master | operational_record | - | - | required | personal_content, submit_lock | `:manage` | - |
| 19 | `scorm_packages` | SCORM Package | SCORM Packages | master | operational_workflow | - | - | required | - | `:manage` | - |
| 20 | `xapi_statements` | xAPI Statement | xAPI Statements | master | operational_record | - | - | required | personal_content | `:manage` | - |
| 21 | `cost_centers` | Cost Center | Cost Centers | embedded_master | unclassified | `erp-fin-gl-close` | General Ledger and Close | optional | - | `:manage` _(pending)_ | - |
| 22 | `employees` | Employee | Employees | embedded_master | operational_workflow | `hcm-core-worker` | Core Worker Record | required | personal_content | `:manage` | - |
| 23 | `org_units` | Org Unit | Org Units | embedded_master | operational_workflow | `hcm-org-positions` | Organisation and Position Management | optional | - | `:manage` | - |
| 24 | `hcm_positions` | Position | Positions | embedded_master | operational_workflow | `hcm-org-positions` | Organisation and Position Management | optional | single_approver | `:manage` | - |
