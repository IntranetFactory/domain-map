...
description: >-
  Use this skill for any task involving the HVAC Service Management (small-org starter) domain (HVAC-SVC-MGMT)
  in this Semantius deployment. Trigger phrases: hvac-svc-mgmt.
  Entities covered: Contacts, Customer Invoices, Customer Sites, Customers, Dispatch Records, Field Visits, Installed Equipment, Sales Quotes, Service Contracts, Service PM Schedules, Service Work Orders, Spare Part Inventory Items, Users.
  Workflows covered: Dispatch and Routing Optimization, Installed Equipment Management, Mobile Technician Enablement, Field Parts and Truck Stock Management, Preventive Maintenance Planning, Service Contract and SLA Management.
  Adjacent skills (use them instead for their own scope): use-cpq, use-crm, use-fsm, use-ham, use-sub-mgmt.
