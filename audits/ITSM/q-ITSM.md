...
q10: Test Management forwards incident to IT Service Management to eliminate quality and reliability problems, but IT Service Management does not yet have anyone assigned to eliminate quality and reliability problems, so this step has no owner. How should it be handled?
- a) Record it now as work IT Service Management owns, and assign a named owner once IT Service Management sets up who does this work.
- b) Leave it off the list for now.
...
q11: Data and AI Platform forwards incident to IT Service Management to develop and execute IT resilience and continuity operations, but IT Service Management does not yet have anyone assigned to develop and execute IT resilience and continuity operations, so this step has no owner. How should it be handled?
- a) Record it now as work IT Service Management owns, and assign a named owner once IT Service Management sets up who does this work.
- b) Leave it off the list for now.
...
q12: Discovery and Service Mapping forwards incident to IT Service Management to operate and monitor online systems, but IT Service Management does not yet have anyone assigned to operate and monitor online systems, so this step has no owner. How should it be handled?
- a) Record it now as work IT Service Management owns, and assign a named owner once IT Service Management sets up who does this work.
- b) Leave it off the list for now.
...
q13: Data Quality forwards incident to IT Service Management to triage SLA compliance issues, but IT Service Management does not yet have anyone assigned to triage SLA compliance issues, so this step has no owner. How should it be handled?
- a) Record it now as work IT Service Management owns, and assign a named owner once IT Service Management sets up who does this work.
- b) Leave it off the list for now.
...
q14: Data Quality forwards incident to IT Service Management to resolve IT issues or requests, but IT Service Management does not yet have anyone assigned to resolve IT issues or requests, so this step has no owner. How should it be handled?
- a) Record it now as work IT Service Management owns, and assign a named owner once IT Service Management sets up who does this work.
- b) Leave it off the list for now.
...
q15: Enterprise Asset Management forwards incident to IT Service Management to perform corrective asset maintenance and repairs, but IT Service Management does not yet have anyone assigned to perform corrective asset maintenance and repairs, so this step has no owner. How should it be handled?
- a) Record it now as work IT Service Management owns, and assign a named owner once IT Service Management sets up who does this work.
- b) Leave it off the list for now.
...
q16: Governance, Risk and Compliance forwards incident to IT Service Management to create remediation plans, but IT Service Management does not yet have anyone assigned to create remediation plans, so this step has no owner. How should it be handled?
- a) Record it now as work IT Service Management owns, and assign a named owner once IT Service Management sets up who does this work.
- b) Leave it off the list for now.
...
q17: Knowledge Management forwards knowledge article to IT Service Management to maintain service support knowledge repository, but IT Service Management does not yet have anyone assigned to maintain service support knowledge repository, so this step has no owner. How should it be handled?
- a) Record it now as work IT Service Management owns, and assign a named owner once IT Service Management sets up who does this work.
- b) Leave it off the list for now.
...
q18: Low-Code Application Platform forwards incident to IT Service Management to manage change deployment control, but IT Service Management does not yet have anyone assigned to manage change deployment control, so this step has no owner. How should it be handled?
- a) Record it now as work IT Service Management owns, and assign a named owner once IT Service Management sets up who does this work.
- b) Leave it off the list for now.
