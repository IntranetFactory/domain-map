...
q14: Digital Asset Management forwards creative deliverable to Agency Management Software to assess and approve content, but Agency Management Software does not yet have anyone assigned to assess and approve content, so this step has no owner. How should it be handled?
- a) Record it now as work Agency Management Software owns, and assign a named owner once Agency Management Software sets up who does this work.
- b) Leave it off the list for now.
...
q15: Core Financial Management forwards media plan to Agency Management Software to perform general accounting, but Agency Management Software does not yet have anyone assigned to perform general accounting, so this step has no owner. How should it be handled?
- a) Record it now as work Agency Management Software owns, and assign a named owner once Agency Management Software sets up who does this work.
- b) Leave it off the list for now.
...
q16: Core Financial Management forwards insertion order to Agency Management Software to process accounts payable (AP), but Agency Management Software does not yet have anyone assigned to process accounts payable (AP), so this step has no owner. How should it be handled?
- a) Record it now as work Agency Management Software owns, and assign a named owner once Agency Management Software sets up who does this work.
- b) Leave it off the list for now.
...
q17: Source-to-Pay forwards insertion order to Agency Management Software to audit invoices and key data in AP system, but Agency Management Software does not yet have anyone assigned to audit invoices and key data in AP system, so this step has no owner. How should it be handled?
- a) Record it now as work Agency Management Software owns, and assign a named owner once Agency Management Software sets up who does this work.
- b) Leave it off the list for now.
