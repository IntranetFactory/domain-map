...
| B1-B10b | B10b | 8 handoffs all NULL source / target module FKs | B1-M1 for source side; CSM (DMDOs) / ERP-FIN / GRC / TELEMATICS modularization for target side |
...
- B1-B10b target side blocked separately on CSM (DMDOs), ERP-FIN, GRC, TELEMATICS modularization.
...
- ERP-FIN: modularize (zero modules today) to unblock handoff 905, 906, 909 target-side PATCH.
