...
Recommended: a. Splitting credentials into a dedicated surface matches security-conscious deployments and keeps each area cleanly owned; folding (b) is also valid if you want it leaner. This choice drives every module, capability, and downstream link below it, so it unlocks the rest of the build.
