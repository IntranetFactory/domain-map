...
| ERP-FIN | 1 (org_unit.created) | 0 | cost_centers contributor | 2 | Lightweight |
...
| 390 | HCM-ORG-POSITIONS → ERP-FIN | `org_unit.created` | Perform general accounting (10742 L3) or Manage chart of accounts | medium |
...
- **ERP-FIN ↔ HCM (2).** Outbound 390 fully wired (FK populated, scratch); contributor `cost_centers` on HCM-CORE-WORKER and HCM-ORG-POSITIONS declared.
...
| ERP-FIN | Add consumer DMDO on `org_units` per outbound 390; populate target_module on 390. |
