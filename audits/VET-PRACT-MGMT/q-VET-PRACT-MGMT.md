...
q11: Governance, Risk and Compliance forwards controlled substance ledger entry to Veterinary Practice Management to report incidents and risks to regulatory bodies, but Veterinary Practice Management does not yet have anyone assigned to report incidents and risks to regulatory bodies, so this step has no owner. How should it be handled?
