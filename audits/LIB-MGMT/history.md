...
| FIN (65) | B10b inbound DMDO declaration on `library_acquisition_orders` for encumbrance budgeting | Same shape as AP-AUTO above. Surface if FIN wants the explicit edge. |
...
| FIN (65) | B10b inbound DMDO on `library_acquisition_orders` for encumbrance budgeting | Same pattern as AP-AUTO. |
