...
q16: Governance, Risk and Compliance forwards hardware disposal record to Hardware Asset Management to manage disposition, disposal, reprocessing activities, but Hardware Asset Management does not yet have anyone assigned to manage disposition, disposal, reprocessing activities, so this step has no owner. How should it be handled?
- a) Record it now as work Hardware Asset Management owns, and assign a named owner once Hardware Asset Management sets up who does this work.
- b) Leave it off the list for now.
