...
| ID | Band | Finding | Fix |
|---|---|---|---|
| B1-S1 | B10b report-only (outbound NULLs) | 4 outbound handoffs carry NULL target_domain_module_id: 364 (FDS-CSA-MGMT to ERP-FIN, csa_subscription.charged, csa_memberships), 960 (FDS-MARKET-POS to ERP-FIN, farmers_market_sale.recorded, farmers_market_sales), 961 (FDS-WHOLESALE to ERP-FIN, wholesale_order.confirmed, wholesale_orders), 963 (FDS-BUTCHER to FOOD-TRACE, butcher_order.ready, butcher_orders). | Schedule b1 audits for ERP-FIN and FOOD-TRACE to populate target_domain_module_id. |
