...
Carrying forward from 2026-05-30 (the cross-domain dependency chain). The 2026-05-31 Continuation cleared the agent-solvable APQC + users-edges work; everything else still gates on Bucket 2 #1 (module split) or on partner-domain audits (TELEMATICS, FLEET-MAINT, ERP-FIN module shapes).
