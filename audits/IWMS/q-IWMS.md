...
q12: Identity Governance and Administration forwards desk booking to Workplace and Space Management to manage IT user authorization, but Workplace and Space Management does not yet have anyone assigned to manage IT user authorization, so this step has no owner. How should it be handled?
- a) Record it now as work Workplace and Space Management owns, and assign a named owner once Workplace and Space Management sets up who does this work.
- b) Leave it off the list for now.
...
<!-- agent map, ignore: q1=B2-SPLIT q2=B2-CAP q3=B2-FLAGS.deskbooking q4=B2-FLAGS.roomreservation q5=B2-FLAGS.servicerequest q6=B1A-N15 q7=B2-FLOOR q8=B3-MOVE-ORDERS+B3-PARKING+B3-WAYFINDING+B3-OCC-SENSORS+B3-MODULAR q9=B3-COMPLIANCE q10=B3-BMS q11=B2-B9D-OWN-1371 q12=B2-B9D-OWN-1196 | domain_id=23 -->
